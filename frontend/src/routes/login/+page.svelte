...
>
	<div class="surface max-w-md w-full p-8 text-center shadow-2xl">
		...
		<!-- Offline Message -->
		{#if !$isOnline}
			<div class="mb-6 p-6 bg-warning/10 border border-warning/30 rounded-lg">
				<div class="text-4xl mb-3">📡</div>
				<h2 class="text-lg font-semibold text-warning mb-2">You're Offline</h2>
				...
				<p class="text-text-secondary/70 text-xs">
					If you were previously signed in, your session may have expired.
				</p>
			</div>
		{:else}
			<!-- Sign In Button -->
